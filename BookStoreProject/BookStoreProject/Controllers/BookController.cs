...
namespace BookStoreProject.Controllers
{
    public class BookController : Controller
    {
        ...
        {
            string comd = "SELECT * FROM [dbo].[Book] WHERE Book_ID =" + id;
        ...
        public Book getBook(String id)
        {
            try
            {
                con.Open();
                com.Connection = con;
                com.CommandText = "SELECT * FROM [dbo].[Book] WHERE Book_ID = " + id;
        ...
        public List<Book> FetchBookWithStr(string books_str)// books_str = "7"
        {
            ...
            if (books_str.Contains(";"))
            {
                ...
                {
                    string command = "SELECT * FROM [dbo].[Book] WHERE Book_ID = " + books_arr[i];
                    books.Add(FetchBook(command)[0]);
                }
            }
            else if (books_str.Length>0)
            {
                string comd = "SELECT * FROM [dbo].[Book] WHERE Book_ID =" + books_str;
